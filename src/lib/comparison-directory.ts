...
export const COMPARISONS: ComparisonMeta[] = [
  ...
  {
    slug: 'deepseek-v4-pro-vs-claude-opus-4-7',
    ...
    benchmarkNameB: 'Claude Opus 4.7',
    seoTitle: 'DeepSeek V4 Pro vs Claude Opus 4.7 (2026): Open Source vs Closed',
    seoDescription:
      'DeepSeek V4 Pro vs Claude Opus 4.7. The best open source model against the best closed model. MIT license, 1M context, and near-frontier benchmarks at a fraction of the price.',
    intro:
    ...
    verdicts: [
      { category: 'Benchmarks', winner: 'B', reason: 'Claude leads on MMLU-Pro (93.8 vs 91.5) and GPQA Diamond (76.5 vs 73.1)' },
      { category: 'SWE-bench', winner: 'tie', reason: 'Near-identical: DeepSeek at 80.6% vs Claude at 82.4% on Verified' },
      { category: 'Pricing', winner: 'A', reason: 'DeepSeek at $1.74/$3.48 vs Claude at $15/$75 per 1M tokens' },
      { category: 'License', winner: 'A', reason: 'MIT license allows unrestricted use, fine-tuning, and self-hosting' },
      { category: 'Context window', winner: 'tie', reason: 'Both offer 1M token context windows' },
      { category: 'Agent ecosystem', winner: 'B', reason: 'Claude has MCP, Claude Code, and the broadest agent tooling' },
    ],
    chooseA: [
